---
layout: blog
title: "Por dentro das AWS Lambdas"
date: 2023-08-02
tags:
  - aws
---
...
![Ilustração do cold start](https://docs.aws.amazon.com/images/lambda/latest/operatorguide/images/perf-optimize-figure-1.png)
...
- Instanciar objetos fora da função handler: Isso faz com que o objeto seja instanciado apenas uma vez (no cold start), e não a cada execução da Lambda. Você pode ler mais sobre isso [aqui](https://docs.aws.amazon.com/pt_br/lambda/latest/operatorguide/static-initialization.html).
...
![Gráfico mostrando o provisioned concurrency](https://docs.aws.amazon.com/images/lambda/latest/operatorguide/images/perf-optimize-figure-6.png)
...
![Ilustração do funcionamento da lambda layers](https://docs.aws.amazon.com/images/lambda/latest/dg/images/lambda-layers-diagram.png)
