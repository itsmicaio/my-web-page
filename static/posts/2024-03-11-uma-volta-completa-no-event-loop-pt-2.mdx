...
> [Na primeira parte desse artigo](/posts/uma-volta-completa-no-event-loop-pt-1), falei sobre o que é o Event Loop e como ele funciona de forma prática e com muitos exemplos.
