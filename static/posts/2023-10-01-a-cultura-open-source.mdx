...
O [patch-package](https://www.npmjs.com/package/patch-package) é uma ferramenta que permite você fazer alterações em projetos que você não é o dono e nem quer esperar todo o tramite de aceite de PR. O bacana e que você pode enviar essas alterações para o Github e o criar automaticamente a PR, essa ferramenta é fantástica e eu uso bastante.

**Se você quiser aprender mais sobre essa lib, fica ligado que semana que vem sai um post sobre o patch-package**.
